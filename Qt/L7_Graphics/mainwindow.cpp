    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this, &MainWindow::graphDataIsReady, this, &MainWindow::rcvGraphData);
}
...
void MainWindow::on_pb_start_clicked()
{
    ...
    auto findMax = [&](QVector<double> res){
                                                ...
                                                for (int i = 0; i < 1000; ++i) {
                                                    xData.push_back(i);
                                                    yData.push_back(res[i]);
                                                }

                                                emit graphDataIsReady(xData, yData);
...
void MainWindow::rcvGraphData(QVector<double> x, QVector<double> y) {
    graphWindow->addGraph(x, y);
    graphWindow->exec();
}
